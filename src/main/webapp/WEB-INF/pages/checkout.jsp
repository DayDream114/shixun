...
<div id="userBar" style="display: none;">
    <a class="layui-btn  layui-btn-danger layui-btn-xs" lay-event="edit">退房</a>
</div>
<!-- 数据表格结束 -->
<!-- 添加和修改的弹出层开始 -->
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="date" class="layui-input" name="Etime" id="ID-laydate-demo" placeholder="yyyy-mm-dd">
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    layui.use([ 'jquery', 'layer', 'form', 'table','laydate','laypage'], function() {
        ...
        var tableIns = table.render({
            elem: "#checkTable",//渲染的table元素
            url: "/getRecard",//获取用户的请求路径
            title: "开房记录表",
            ...
            cols: [[  //表格的列
                ...
                {field: "name" ,title: "开房人姓名" ,align:"center"},
                ...
                {field: "stime",title: "开房时间",align: "center"},
